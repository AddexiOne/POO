...
namespace SpaceInvadersArmory
{
    public class Armory
    {
        ...
        private void Init()
        {
            blueprints.Add(new WeaponBlueprint { Name = "Laser", Type = EWeaponType.Direct, MinDamage = 2, MaxDamage = 3, ReloadTime = 2 });
            ...
            blueprints.Add(new WeaponBlueprint { Name = "EMG", Type = EWeaponType.Explosive, MinDamage = 1, MaxDamage = 7, ReloadTime = 1.5 });
            blueprints.Add(new WeaponBlueprint { Name = "Missile", Type = EWeaponType.Guided, MinDamage = 4, MaxDamage = 100, ReloadTime = 4 });
        }
