...
namespace SpaceInvadersArmory
{
    public class WeaponBlueprint: ICloneable, IEquatable<WeaponBlueprint>
    {
        ...
        public object Clone()
        {
            return new WeaponBlueprint { Id = this.Id, Name = this.Name, Type = this.Type, MinDamage = this.MinDamage, MaxDamage = this.MaxDamage, ReloadTime = this.ReloadTime, TimeBeforeReloaded = this.TimeBeforeReloaded};
        }
